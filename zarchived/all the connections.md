You are building a mobile-first HTML symptom navigation tool for a functional medicine knowledge system containing 33 validated lab variables and 463 connections. Your source of truth is the knowledge base I've described below. Build a single self-contained HTML file — no external dependencies, no frameworks, inline CSS and JS only.
